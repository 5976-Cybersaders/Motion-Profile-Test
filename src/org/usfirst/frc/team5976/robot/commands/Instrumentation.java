...
public class Instrumentation {
	...
	static int count = 0;
	static DecimalFormat formatter = new DecimalFormat("#.000000");
	...
	public static void process(String name, CANTalon.MotionProfileStatus status1) {
		...
		//if((now-timeout) > 0.2){
			...
			System.out.format("%-9s\t", formatter.format(round(status1.activePoint.position)));
			System.out.format("%-9s\t", formatter.format(round(status1.activePoint.velocity)));
