...
public class ReportHelper {
	...
	public static void reportExecute(CANTalon talon, String side, PowerDistributionPanel pdp, int pdpPort,
			int stableCount, double avgError) {
		double set = talon.getSetpoint();
		...
		// Gets the current status of the Talon (usually a sensor value).
				...
				// When using analog sensors, 0 units corresponds to 0V, 1023 units corresponds
